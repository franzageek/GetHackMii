...
echo.
echo.
call :colorEcho df "# Press 1 to begin"
choice /c 1 /n > NUL
...
wget https://raw.githubusercontent.com/franzageek/GetHackMii/files/hackmii_installer.zip 2>nul
title GetHackMii v0.1.2
call :colorEcho 0a " [OK]"
echo  Done.
echo  [**] Extracting...
...
if exist .wget-hsts del /F /S /Q .wget-hsts > nul 2>&1
if exist %cd%\hackmii_installer\ rmdir /S /Q %cd%\hackmii_installer\ > nul 2>&1
